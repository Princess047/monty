...
{
        int i = 0;
        instruction_t instructions[] = {{"push_handler", push_handler}, {"sub_handler", sub_handler}, {"pstr_handler", pstr_handler},
                                        {"div_handler", div_handler}, {"mul_handler", mul_handler}, {"pall_handler", pall_handler},
                                        {"pint_handler", pint_handler}, {"nop_handler", nop_handler}, {"pchar", pchar},
                                        {"mod_handler", mod_handler}, {"pop_handler", pop_handler}, {"swap_handler", swap_handler},
                                        {"add_handler", add_handler}, {"rotl_handler", rotl_handler}
                                        , {"rotr_handler", rotr_handler}, {NULL, NULL}};
        i = 0;
...
{
        free(helpy.buffer);
        free_dlistint_handler(helpy.head);
        fclose(helpy.fp);
}
/**
