#include "monty.h"
/**
 * sub_handler - subtracts top two elements of stack
...
/**
 * mul_handler - multiplies second top element by top element of the stack.
 * @head: pointer to a pointer to a struct of type stack_t
 * @line_number: line number of instruction
 *
 * Return: void
...
/**
 * mod_handler - computes the rest of the division of second top by top element
 * @head: pointer to a pointer to a struct of type stack_t
 * @line_number: line number of instruction
 *
 * Return: void
